...
ax2.set_title("IG attribution (14x14 patch grid)", fontsize=11)
ax2.axis("off")
...
fig.text(0.5, -0.02,
         "IG params: m=300 steps  |  baseline: black image (preprocessed zeros)  |  target: log_softmax  |  note: patch-shaped patterns from 16px patch embedding",
         ha="center", fontsize=9, fontstyle="italic", color="0.4")

plt.tight_layout()
plt.savefig("output/ig_vit.png", dpi=150, bbox_inches="tight")
print("saved ig_vit.png")
